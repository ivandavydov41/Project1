...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.heading("payment", text="Заработная плата")
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        self.entry_pay.place(x=200, y=110)
        ...
        self.btn_ok.bind(
            ...
            lambda event: self.view.records(
                self.entry_name.get(), self.entry_email.get(), self.entry_tel.get(), self.entry_pay.get()
            ),
        )
